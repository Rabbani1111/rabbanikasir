...
<form class="form-signin" method="post" action="aksi_daftar.php">
  ...
  <label for="inputEmail" class="sr-only">NamaLengkap</label>
  <input type="text" id="text" name="NamaLengkap" class="form-control" placeholder="Isi NamaLengkap...." required autofocus>

  <label for="inputPassword" class="sr-only">username</label>
  <input type="text" id="username" name="username" class="form-control" placeholder="Isi username...." required>

  <label for="inputPassword" class="sr-only">password</label>
  <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Isi password...." required>
